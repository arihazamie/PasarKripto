...
const DominanceApp = () => {
  ...
  return (
    <>
      <div className="py-5 text-center text-xl">Dominance percentage as compared to other cryptocurrencies in the top ranking.</div>
      <div className="mx-40 rounded-lg border-2 mb-5 bg-MyPurple/5">
